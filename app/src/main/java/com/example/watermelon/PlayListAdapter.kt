...
class PlayListAdapter(private val callback: (MusicModel) -> Unit): ListAdapter<MusicModel, PlayListAdapter.ViewHolder>(diffUtil) {
    ...
    companion object {
        val diffUtil = object: DiffUtil.ItemCallback<MusicModel>() {
            override fun areItemsTheSame(oldItem: MusicModel, newItem: MusicModel) = oldItem.id == newItem.id

            override fun areContentsTheSame(oldItem: MusicModel, newItem: MusicModel) = oldItem == newItem
